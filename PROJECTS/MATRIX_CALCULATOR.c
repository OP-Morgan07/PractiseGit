...
#include <math.h>
int S;
void multiplication1(int m1, int m2, int n1, int n2, float mat1[m1][n1], float mat2[m2][n2])
{
	float mat3[m1][n2];
...
// void inverseStore(int x,int aug[x][x],int constant[x][1]){
